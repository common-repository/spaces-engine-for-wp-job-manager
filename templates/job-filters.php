	...
	<div class="search_jobs">
		...
		<?php if ( apply_filters( 'job_manager_job_filters_show_remote_position', get_option( 'job_manager_enable_remote_position', true ), $atts ) ) : ?>
			<div class="search_remote_position">
				...
				<label for="remote_position" class="checkbox-label" id="remote_position_label"><?php esc_html_e( 'Remote positions only', 'wp-job-manager' ); ?></label>
			</div>
		<?php endif; ?>
		...
		<input type="hidden" name="space_id" value="<?php echo esc_attr( wpe_wps_get_id() ); ?>" />
